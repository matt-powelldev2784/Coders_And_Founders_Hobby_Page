...
console.log('nextFiveTourDates', nextFiveTourDates)

const tourList = document.querySelector('#five_recent_tour')

nextFiveTourDates.forEach((tourInfo) => {
  //create list item
  ...
  const tourCityText = document.createTextNode(tourInfo.city)
